...
- **Offline fallback**: local storage acts as a cache/fallback, not a two-way sync — if you log climbs (or goals) offline and later connect a sheet, those offline entries won't automatically migrate over.
